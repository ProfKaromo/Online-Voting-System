...
<html>
	<head>
		...
		<title>Apply for General Secretary</title>
		<script>
	...
	<form  name="frmApply" method="post" enctype="multipart/form-data" action="apply_general_secretary_exc.php">
	<tr>
		<td align = "center"><font color="red">APLLY FOR THE POST OF GENERAL SECRETARY (Use valid details).</font></td>
	</tr>
	<tr>
		<td>
