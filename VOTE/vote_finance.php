...
<body align = "center">
<h1>VOTE FOR FINANCE MINISTER</h1>
<div id="all">
<?php
include('db_connect.php');
 
 $mysql = "SELECT * FROM apply_finance WHERE success='1'";
...
<div id="next">
<button class="button"  onclick="location.href='member_index.php'">Home</a></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button class="button"  onclick="location.href='vote_general_secretary.php'">Back</a></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button class="button"  onclick="location.href='member_index.php'">Done</a></button><br><br>
