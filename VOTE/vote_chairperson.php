...
<h1>VOTE FOR PRESDENT</h1>

<div id="all">
<?php
include('db_connect.php');
 
 $mysql = "SELECT * FROM apply_chairperson WHERE success='1'";
...
<div id="next">
<button class="button"  onclick="location.href='member_index.php'">Home</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<button class="button"  onclick="location.href='vote_general_secretary.php'">Next Post</a></button><br><br>
