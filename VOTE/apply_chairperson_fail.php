...
<html>
	<head>
		...
		<title>Apply for Chairperson</title>
		<script>
	...
	<form  name="frmApply" method="post" enctype="multipart/form-data" action="apply_chairperson_exc.php">
	<tr>
		<td align = "center"><font color="red">APLLY FOR THE POST OF CHAIRPERSON (Use valid details).</font></td>
	</tr>
	<tr>
		<td>
			<table border = "0"align = "center">
			<tr><td>Reg No.:</td><td><input type = "text" name = "reg_no" value="<?php echo $_SESSION['reg_no']; ?>" class= "txtField" readonly></td></tr>
			...
			<tr><td>Year of Study:</td><td><select name = "year" id = "select" class= "txtField">
