<html>
	...
	<tr>
		<td align = "center">FILL YOUR DETAILS TO REGISTER</td>
	</tr>
	<tr>
		<td>
			<table border = "0">
			...
			<tr><td>Password:</td><td><input type = "password" name = "password" class= "txtField"id ="password" onchange="testLength()"></td></tr>
