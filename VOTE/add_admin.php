<html>
	...
	<tr>
		<td align = "center">FILL THE DETAILS OF THE NEW ADMIN</td>
	</tr>
	<tr>
		<td>
			<table border = "0">
			...
			<tr><td>Password:</td><td><input type = "password" id="password" name = "password" class= "txtField" onchange="testLength()"></td></tr>
